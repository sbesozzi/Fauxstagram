...
var APP_ID = 'GIsxsPDh2WD7JkvpiiCCnjYZslw7tSCB8UKCaiK4';
var API_KEY = 'W5xEIV2rfAfshMRZ4J0YsdTYSjQhzbCpGuEWfk80';
...
var _image_model = require('./image_model');

var _image_model2 = _interopRequireDefault(_image_model);

var imagesCollection = _backbone2['default'].Collection.extend({

  url: 'https://api.parse.com/1/classes/images',

  model: _image_model2['default'],
...
exports['default'] = imagesCollection;
module.exports = exports['default'];

},{"./image_model":2,"backbone":10}],4:[function(require,module,exports){
'use strict';
...
var _images_collectionJs = require('./images_collection.js');

var _images_collectionJs2 = _interopRequireDefault(_images_collectionJs);

var _viewsImages = require('./views/images');

var _viewsImages2 = _interopRequireDefault(_viewsImages);

var _viewsImage = require('./views/image');

var _viewsImage2 = _interopRequireDefault(_viewsImage);

var _viewsAdd = require('./views/add');

var _viewsAdd2 = _interopRequireDefault(_viewsAdd);

var _viewsEdit = require('./views/edit');
...
},{"./images_collection.js":3,"./views/add":6,"./views/edit":7,"./views/image":8,"./views/images":9,"backbone":10,"jquery":11}],6:[function(require,module,exports){
"use strict";
...
exports['default'] = imagesTemplate;
module.exports = exports['default'];
